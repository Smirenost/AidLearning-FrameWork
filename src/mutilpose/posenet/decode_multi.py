...
def get_instance_score(existing_poses, squared_nms_radius, keypoint_scores,
                       keypoint_coords):
...
def get_instance_score_fast(exist_pose_coords, squared_nms_radius,
...
def score_is_max_in_local_window(keypoint_id, score, hmy, hmx,
